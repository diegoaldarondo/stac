...
stac-submit-unfinished ./stac_params/submission_params.yaml
sbatch --wait /n/holylfs02/LABS/olveczky_lab/Diego/code/dm/stac/stac_merge.sh


# Preprocess npmp and merge if successful
parallel-npmp-preprocessing ./stac/total.hdf5 ./npmp_preprocessing
sbatch /n/holylfs02/LABS/olveczky_lab/Diego/code/dm/stac/npmp_merge.sh
