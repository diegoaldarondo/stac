...
data = dict(
    ...
    _IS_LIMB=["scapula", "hip", "knee", "shoulder", "elbow"],
    ...
    q_reg_coef=0.0,
    m_reg_coef=0.9,
    scale_factor=optimize_scale_factor(data_path, param_base_path, start_frame),
    z_perc=5,
    z_offset=0.02,
    adaptive_z_offset_value=0.02,
