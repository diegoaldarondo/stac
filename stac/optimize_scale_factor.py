...
def scale_loss(scale_factor, params, kp_data, kp_names):
    ...
    """
    kp_data = preprocess_data(scale_factor, params, kp_data, kp_names)
...
def preprocess_data(
    scale_factor, params, kp_data, kp_names, struct_name="markers_preproc"
):
...
def optimize_scale_factor(data_path, param_path, start_frame, *, n_frames=50, skip=10):
    ...
    kp_data, kp_names = util.load_kp_data_from_file(
        data_path, struct_name="markers_preproc"
    )
